	...
	<div class="col-lg-5 mx-auto p-3 py-md-5">
		<form action="editPromo.do" method="post">
			...
			<div class="modal-body">
				...
				<div class="mb-3">
					<label for="tipoAtr" class="col-form-label ">Tipo de
						promoción:</label> <select name="tipoAtr" class="form-select"
				...
				<div class="mb-3">
					<label for="atrEnPromo" class="col-form-label">Tipo atraccion
						preferida:</label> <select multiple name="atrEnPromo" class="form-select"
						aria-label="Default select example">
