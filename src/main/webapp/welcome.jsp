			...
			<div id="carouselExampleDark" class="carousel carousel-dark slide"
				...
				<div class="carousel-inner container-sm">
					<div class="carousel-item active " data-bs-interval="10000">
						<img src="/tierraMedia/assets/images/6.jpg" class="d-block w-100  " alt="...">
					...
					<div class="carousel-item" data-bs-interval="2000">
						<img src="/tierraMedia/assets/images/5.jpg" class="d-block w-100" alt="...">
						<div class="carousel-caption d-none d-md-block">
							<h1>Promociones</h1>
					...
					<div class="carousel-item">
						<img src="/tierraMedia/assets/images/7.jpg" class="d-block w-100" alt="...">
						<div class="carousel-caption d-none d-md-block">
							<h1>Próximamente </h1>
