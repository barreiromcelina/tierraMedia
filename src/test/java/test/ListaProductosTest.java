...
public class ListaProductosTest {
	...
	Atraccion atraccion4 = new Atraccion(4, "Minas Tirith", 5, TipoAtraccion.PAISAJE, 25, 2.5);
	Atraccion atraccion5 = new Atraccion(5, "Abismos de Helm", 5, TipoAtraccion.PAISAJE, 15, 2);
